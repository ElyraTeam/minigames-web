    ...
    <div className="word-main pt-8 h-screen text-white">
      ...
      <div className="content relative z-10 mx-auto">
        ...
        <div className="buttons text-center mt-28 pb-10">
          <Link href="/">
            <button className="homepage text-xl mr-8 px-12 py-3 text-primary rounded-2xl border-primary border">
              الواجهة الرئيسية
            </button>
          </Link>

          <Link href="/games/word/create">
            <button className="start-new-main text-xl px-12 py-3 text-white rounded-2xl bg-gradient-to-r from-btngradient-from to-btngradient-to">
              ابدأ لعبة جديدة
            </button>
          </Link>
        </div>
