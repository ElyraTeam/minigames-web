  ...
  return (
    <div className="getstarted-main">
      ...
      <div className="flex flex-col h-screen justify-center items-center text-center">
        ...
        <Card
          className={classNames('absolute w-[30rem] bg-white rounded-2xl transition-transform duration-500 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20', {
            'scale-[0]': !showCreds,
          })}
        >
          {creds.map((u, i) => (
        ...
        <div className={classNames('overlay absolute h-full w-full top-0 left-0 cursor-pointer bg-[rgba(0,0,0,0.4)] z-10', {
          'hidden': !showCreds,
