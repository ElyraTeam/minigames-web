        ...
        {categories.map((category) => {
          return (
            <div
              ...
              className="relative transition-all py-3 px-8 mx-2 my-2 text-lg bg-white rounded-3xl flex justify-center items-center shadow-[0_4px_8px_0_rgba(0,0,0,0.3)] w-50"
            >
              <FaTimes
